...
This keeps the global layer small and stable.
...
| Type | Skill | Purpose |
| --- | --- | --- |
| Process | `using-superpowers` | Decide whether a skill should be used before acting |
| Router | `skill-router` | Choose the correct project directory |
