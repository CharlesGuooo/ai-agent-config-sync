...
description: Advanced SwiftUI animations — springs, custom transitions, matchedGeometryEffect hero animations, PhaseAnimator/KeyframeAnimator, and Metal shader effects. Use when building animations, view transitions, hero animations, micro-interactions, or GPU-accelerated effects in SwiftUI (iOS/macOS).
---
